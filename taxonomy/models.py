...
class TaxonomyBaseInfo(models.Model):
    ...
    common_name = models.CharField(max_length=100, default='', blank=True, help_text='Enter the common name')
...
class Family(TaxonomyBaseInfo):
    ...
    image = models.FileField(upload_to='insect-photos', blank=True)
    ...
    def get_image_url(self):
        return f'{self.image.url}' if self.image else ''
